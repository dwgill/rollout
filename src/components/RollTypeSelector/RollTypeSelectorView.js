...
import { augmentedDescription, classicDescription, standardDescription } from './descriptions';

const options = keys(rollTypes);

const formatOption = (/** @type {string} */ opt) => {
    return opt.substring(0, 1).toLocaleUpperCase() + opt.substring(1).toLocaleLowerCase();
}
